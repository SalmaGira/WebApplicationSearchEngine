	...
	public void htmlSaver(String webpage, String title) {
		try {
			...
			BufferedWriter writer =
					new BufferedWriter(new FileWriter("E:\\Study\\2nd Semester\\APT\\Project\\5\\SearchEngineProject\\html/" + title + ".html"));

			BufferedWriter writer2 =
					new BufferedWriter(new FileWriter("E:\\Study\\2nd Semester\\APT\\Project\\5\\SearchEngineProject\\html2/" + title + ".html"));

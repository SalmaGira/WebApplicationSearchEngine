...
public class Extractor {
    ...
    public void extractFromHtml(String htmlPath, int numberOfUrls) throws IOException, InterruptedException {
        ...
        String titlesPath = "E:\\Study\\2nd Semester\\APT\\Project\\5\\SearchEngineProject\\data\\documentsTitlesTotal.txt";
        String plaintextPath = "E:\\Study\\2nd Semester\\APT\\Project\\5\\SearchEngineProject\\data\\plaintextsTotal.txt";
                ...
                if (event.kind() ==ENTRY_MODIFY && !filePath.equals(lastfilepath)) {
                    ...
                    for (String part : htmlParts) {
                        ...
                        if (!title.isEmpty() || !header.isEmpty() || !string.isEmpty()) {
                            // Write in files
                            try {
                                String filename = "E:\\Study\\2nd Semester\\APT\\Project\\5\\SearchEngineProject\\filename" + Integer.toString(i) + ".txt";
